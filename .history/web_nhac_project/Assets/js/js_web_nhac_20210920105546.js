...
const app = {
    ...
    songs: [{
            ...
            image: "./Assets/img/thao_pham.jpg",
        },
        {
    ...
    // Tạo ra phương thức mặc định trong app
    ...
    handleEvents: function() {
        ...
        // Khi song được play , lắng nghe sự kiện kiểm tra thực sự play
        ...
        // Khi song bị pause , lắng nghe sự kiện kiểm tra thực sự pause
        ...
        audio.ontimeupdate = function() {
            if (audio.duration) {
                const progressPercent = Math.floor(
                    //currentTime là thời gian bắt đầu chạy của bài hát
                    //
