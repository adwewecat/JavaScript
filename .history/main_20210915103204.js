...
var numbers = [0, 1, 2, NaN, function(){}]
// function run(inputs) {
...
function sum(numbers) {
    var totalnumber = numbers.filter(function(accumulator,currentValue){
        return currentValue === 'number' ? accumulator+currentValue:false
}, 0); 
    return totalnumber;
}
