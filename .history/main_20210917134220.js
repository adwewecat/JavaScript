...
// var h1Element = document.querySelector('h1:first-child')

// var textNode1 = document.querySelector('div').lastElementChild
...
//Sự kiện này thực thi khi nhập xong và bấm chuột ra khỏi ô input
inputElement.onchange = function(e) {
    console.log(e.target.value)
}

//Sự kiện này thực thi khi nhập input
inputElement.oninput = function(e) {
    console.log(e.target.value)
}

//Sự kiện này thực thi khi check vào checkbox
checkElement.onchange = function(e) {
    console.log(e.target.value)
}

//Sự kiện này thực thi khi chọn select vào checkbox
checkElement.onchange = function(e) {
    console.log(e.target.value)
}
