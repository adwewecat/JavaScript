...
function run(title, description) {
    if(title.indexOf('Javascript') != 0 && description.indexOf('Javascript') !=0 ){
        result = true;
        console.log(title.search('Javascript'))
    }else{
        result = false;
        console.log(typeof title.search('Javascript'))
    }
    return result;
}

run('Javascript tai F8','Javascript tai f8');
