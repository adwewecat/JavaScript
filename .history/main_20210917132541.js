...
var inputElement = document.querySelector('input[type="test"]')
h1Element.classList.add('first-heading')
h1Element.nextElementSibling.classList.add('second-heading')

console.log(h1Element.nextElementSibling.classList.add('second-heading'))