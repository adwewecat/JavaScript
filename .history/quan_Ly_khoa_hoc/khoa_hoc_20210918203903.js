...
function changeCourse(data, id, callback) {
    var options = {
        method: 'PATCH',
        headers: {
            'Content-Type': 'application/json'
...
function handleChangeCourse(id) {
    var changeBtn = document.querySelector('#create');
    ...
    changeBtn.onclick = function() {
        ...
        var oldName = document.querySelector('.course-item-name-' + id).textContent;
        var oldDescription = document.querySelector('.course-item-description-' + id).textContent;
        oldName = newName;
        ...
        changeCourse(formData, id, function() {
