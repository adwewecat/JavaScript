...
function handleUpdateCourse(id) {
    ...
    var name =
        document.querySelector('#h4-name-' + id).textContent
    var description =
        document.querySelector('#p-description-' + id).textContent

    var nameinput = document.querySelector('input[name="name"]').setAttribute('value', name).textContent;

    var descriptioninput = document.querySelector('input[name="description"]').setAttribute('value', description).textContent;
