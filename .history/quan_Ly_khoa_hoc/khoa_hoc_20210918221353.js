...
function handleUpdateCourse(id) {
    ...
    var hideCreate =
        document.querySelector('#create')
    if (hideCreate) { hideCreate.setAttribute('hidden', 'true') }

    var buttonUpdare = document.querySelector('#event')
        // console.log(buttonUpdare)
    buttonUpdare.innerHTML = ` <button id="update">Update</button>`
