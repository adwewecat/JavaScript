...
function stringInString(needle , haystack) {
    console.log(haystack.search(/needle/g))
    
    if ((typeof needle,haystack) =='string' && !undefined(needle,haystack)) {
        console.log('a')
    }
}

stringInString('aaaaaaaa', 'ccccccccccccc aaaaaaaa bbbbbbbb aaaaaaaa')
