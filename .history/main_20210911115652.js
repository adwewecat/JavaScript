...
function checkIdo(){
    var listIdos = [123,123,123]
    var myido = '123'
    console.log(Array.isArray(listIdos))
    console.log(typeof(myido) === 'string')
    console.log(listIdos.indexOf(myido) >= 0)
    if(Array.isArray(listIdos) && typeof(myido) === 'string' && listIdos.indexOf(myido) >= 0)
    {
        // return true
        console.log('true')
    }
...
//     return Array.isArray(idol) && typeof(myidol) === 'string' && idol.indexOf(myidol) >= 0 ? true: false;
// }
